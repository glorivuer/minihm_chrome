...
# Singularity helpers (scratch dir, SIF cache) defined locally as singularity env is pruned
...
def _create_environment(env_type: str, image: str, cwd: str, timeout: int,
    ...
    if env_type == "local":
        ...
        raise ValueError("Singularity/Apptainer environment is not supported in this simplified version of MiniHermes.")
        ...
        raise ValueError("Daytona environment is not supported in this simplified version of MiniHermes.")

    elif env_type == "ssh":
        raise ValueError("SSH environment is not supported in this simplified version of MiniHermes.")
